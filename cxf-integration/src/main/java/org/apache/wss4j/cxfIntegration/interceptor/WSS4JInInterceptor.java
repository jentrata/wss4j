...
public class WSS4JInInterceptor extends AbstractWSS4JInterceptor {
    ...
    public void handleMessage(final SoapMessage msg) throws Fault {
        ...
        try {
            ...
            //--------start attachment code (no other changes) -------------

            reqData.setAttachmentCallbackHandler(new CallbackHandler() {
                @Override
                public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
                    for (int i = 0; i < callbacks.length; i++) {
                        ...
                        if (callback instanceof AttachmentRequestCallback) {
                            ...
                            msg.getAttachments().remove(attachment);
            ...
            //--------end attachment code (no other changes) -------------
            ...
            if (wsResult != null && !wsResult.isEmpty()) { // security header found
                ...
                storeSignature(msg, wsResult);
                storeTimestamp(msg, wsResult);
                checkActions(msg, wsResult, actions);
                doResults(
                    msg, actor, 
    ...
    private void storeSignature(
        SoapMessage msg, List<WSSecurityEngineResult> wsResult
    ) throws WSSecurityException {
        ...
        if ((doAction & (WSConstants.ENCR | WSConstants.UT)) != 0) {
            ...
            if (o instanceof String) {
                try {
                    ...
                    throw new WSSecurityException(WSSecurityException.ErrorCode.INVALID_SECURITY, e.getMessage(), e);
                }
            }            
        ...
        public Validator getValidator(QName qName) throws WSSecurityException {
            ...
            if (key != null) {
                ...
                try {
                    ...
                    throw new WSSecurityException(WSSecurityException.ErrorCode.INVALID_SECURITY, t.getMessage(), t);
                }
            }
